...
void hmp_dump_dirtyspeed(Monitor *mon)
{
    get_dirty_speed();
}

void hmp_stop_dump_dirtyspeed(Monitor *mon)
{
	stop_get_dirty_speed();
}

void hmp_dump_dirtymaps(Monitor *mon)
{
    int num = get_dirty_maps_new();
    monitor_printf(mon, "dirty maps:%d pages dumped in dirtymaps.dat\n", num);
}

void hmp_info_dirtypages(Monitor *mon)
{
    int pages = get_dirty_pages_new();
    monitor_printf(mon, "dirty pages:%d\n", pages);
}
...
void hmp_info_migrate(Monitor *mon)
{
    ...
    if (info->has_ram) {
		...
		//monitor_printf(mon, "interation: %" PRIu64 "\n",
		//			   info->ram->iteration);
    }
